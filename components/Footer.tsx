    ...
    <footer className="border-t border-forest-950/15 bg-brass-500 px-6 py-16 md:px-16">
      <div className="mx-auto max-w-6xl">
        <div className="grid gap-10 md:grid-cols-[1.2fr_1fr_1fr_1fr]">
          <div>
            <p className="font-display text-xl text-forest-950">Greengrand</p>
            <p className="mt-3 max-w-xs text-[13px] leading-relaxed text-forest-950/80">
          ...
          <div>
            <p className="text-[11px] uppercase tracking-widest text-forest-950/70">Shop</p>
            <ul className="mt-4 space-y-2 text-sm text-forest-950">
          ...
          <div>
            <p className="text-[11px] uppercase tracking-widest text-forest-950/70">Company</p>
            <ul className="mt-4 space-y-2 text-sm text-forest-950">
          ...
          <div>
            <p className="text-[11px] uppercase tracking-widest text-forest-950/70">Care</p>
            <ul className="mt-4 space-y-2 text-sm text-forest-950">
        ...
        <div className="mt-14 flex flex-col-reverse items-center justify-between gap-4 border-t border-forest-950/15 pt-6 text-[12px] text-forest-950/80">
          <p>© {new Date().getFullYear()} Greengrand Shirt Co. All rights reserved.</p>
          <p>Bengaluru, India</p>
        </div>

        <div className="mt-4 text-center text-[11px] text-forest-950/60">
